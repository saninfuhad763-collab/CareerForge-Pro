...
const Landing = () => {
  ...
  return (
    <div className="relative min-h-screen bg-slate-50 dark:bg-slate-950 overflow-hidden">
      ...
      <div className="absolute top-[-10%] left-[-10%] w-[500px] h-[500px] bg-indigo-200/40 dark:bg-indigo-900/20 rounded-full blur-[120px] animate-float pointer-events-none" />
      <div className="absolute bottom-[20%] right-[-10%] w-[600px] h-[600px] bg-emerald-100/40 dark:bg-emerald-950/20 rounded-full blur-[140px] animate-float pointer-events-none" style={{ animationDelay: '4s' }} />

      {/* Header Navigation */}
      <nav className="sticky top-0 z-50 glass-card mx-auto max-w-7xl mt-4 px-6 py-4 rounded-2xl flex items-center justify-between border border-slate-200/50 dark:border-slate-800/50">
      ...
      <section className="max-w-7xl mx-auto px-6 pt-16 pb-24 md:pt-24 md:pb-32 grid md:grid-cols-12 gap-12 items-center relative z-10">
        ...
        >
          ...
          >
            <Link
              ...
              className="inline-flex items-center justify-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white px-7 py-4 rounded-2xl font-semibold shadow-lg shadow-indigo-500/20 hover:translate-y-[-2px] transition-all"
            >
        ...
        >
          ...
          <div className="relative glass-card border border-slate-200 dark:border-slate-800 rounded-3xl p-6 shadow-2xl">
            {/* Visualizer Score */}
            ...
            {/* Glowing check overlay */}
            <div className="absolute -bottom-6 -right-6 bg-white dark:bg-slate-900 rounded-2xl p-4 shadow-xl border border-slate-200/50 dark:border-slate-800/50 flex items-center gap-3 animate-float" style={{ animationDelay: '2s' }}>
      ...
      <section id="features" className="max-w-7xl mx-auto px-6 py-20 relative z-10 border-t border-slate-200/50 dark:border-slate-900/50">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {/* Card 1 */}
          <div className="glass-card rounded-2xl p-6 border border-slate-200/50 dark:border-slate-800/50 flex flex-col text-left space-y-4 hover:translate-y-[-4px] transition-all duration-300">
      ...
      <section id="workflow" className="bg-slate-100/50 dark:bg-slate-900/30 py-20 border-y border-slate-200/30 dark:border-slate-900/30 relative z-10">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="glass-card rounded-3xl p-8 border border-slate-200 dark:border-slate-800 relative">
            <div className="text-slate-800 dark:text-slate-200 text-left font-mono text-xs space-y-4">
              ...
              <div className="pt-4 border-t border-slate-200/50 dark:border-slate-800/50 flex justify-between items-center text-[10px] text-slate-400 font-sans">
                ...
                <span className="text-emerald-500 flex items-center gap-1"><div className="w-1.5 h-1.5 rounded-full bg-emerald-500" /> Active</span>
              </div>
            </div>
          </div>
        </div>
